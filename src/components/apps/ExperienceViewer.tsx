...
import { Calendar, Briefcase, ChevronRight, Hash } from 'lucide-react';
...
const experiences = [
  {
    ...
    desc: [
      "Driving product growth and user engagement strategies through full-stack development.",
      "Optimizing platform performance and implementing new features to enhance user retention."
    ],
    tech: ["Next.js", "Analytics", "Optimization"]
  },
  {
    id: 2,
    role: "SDE Intern",
    ...
    desc: [
      "Developed Interacly, an interactive LLM-based platform.",
      "Optimized backend API performance by 20% and integrated generative AI models."
    ],
    tech: ["Generative AI", "Backend Optimization", "LLMs"]
  }
];
              ...
              <ul className="space-y-2 mb-4">
                {exp.desc.map((item, i) => (
                  <li key={i} className="text-sm text-gray-400 flex items-start gap-2">
                    <ChevronRight size={14} className="mt-0.5 text-gray-600" />
                    {item}
                  </li>
                ))}
              </ul>
